...
// 'gsc'/'pagespeed' findings are auto-generated by lib/gsc/auditSync.ts (23 Sep 2026 session,
// migration 0033_audit_finding_source.sql) -- source_key is the page URL or sitemap path used
// to find-and-update/resolve the same finding on the next sync instead of duplicating it.
export type AuditSource = 'manual' | 'gsc' | 'pagespeed'
